		...
		<tr>
				...
				<td id="nap_tuda" width="33%" >
					{php}
						for($i=1;$i<=7;$i++)
						{
							echo '<input type="text" size="5" class="time"  name="time_tuda['.$i.']" id="time_tuda'.$i.'" value="'.$this->_tpl_vars['post']['dni_tuda']['t'.$i].'" ><br>';
						}
					{/php}
				</td>
				...
				<td class="nap_ottuda" width="33%" style="display:none" >
					{php}
						for($i=1;$i<=7;$i++)
						{
							echo '<input type="text" size="5" class="time" name="time_ottuda['.$i.']" id="time_ottuda'.$i.'" value="'.$this->_tpl_vars['post']['dni_ottuda']['t'.$i].'" ><br>';
						}
					{/php}
				</td> 
		</tr>
