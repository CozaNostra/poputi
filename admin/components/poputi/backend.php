	...
	if($opt=='edit_user'){	
		...
		<td align="center" >
							...
							<select name="group_poputi" >
									<option value="1" <? if($user['poputi']==1){echo 'selected';}?> >Пассажир</option>
									<option value="2" <? if($user['poputi']==2){echo 'selected';}?>>Водитель</option>
									<option value="0" <? if($user['poputi']==0){echo 'selected';}?>>Никто</option>
									<option value="9" <? if($user['poputi']==9){echo 'selected';}?>>Заблокирован</option>
							</select>
							<br><br>
	...
	<form action="index.php?view=components&do=config&id=<?php echo (int)$_REQUEST['id'];?>&opt=config" method="post" name="optform" target="_self" id="form1">
		<table width="680" border="0" cellpadding="10" cellspacing="0" class="proptable">
			...
			<tr>
				...
				<td valign="top">
					<input name="key" size="50" type="text" value="<? echo $cfg['key'] ?>"  />
			...
			<tr>
				...
				<td valign="top">
					<input name="titles" size="50" type="text" value="<? echo $cfg['titles'] ?>"  />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td valign="top">
					<input name="max_poputi" size="2" type="text" value="<? echo $cfg['max_poputi'] ?>"  />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td valign="top">
					<input name="max_vp" size="2" type="text" value="<? echo $cfg['max_vp'] ?>"  />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td valign="top">
					<input name="max_count_page" size="2" type="text" value="<? echo $cfg['max_count_page']; ?>"  />
				</td>
			</tr>
			<tr>
